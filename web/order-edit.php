        ...
        <table cellpadding="10" cellspacing="1">
            ...
            <tbody>
                ...
                foreach ($result as $k => $v) {
					$discount1 = $result[$k]["discount1"];
					$discount2 = $result[$k]["discount2"];
					$discount3 = $result[$k]["discount3"];
					$subtotal = $result[$k]["subtotal"];
					$total = $result[$k]["total"];
					
            ?>
				
				<tr data-id='<?php echo $i;?>'>
					<td><input type='hidden' name='car_id[]' value='<?php echo $result[$k]["car_id"]; ?>' /><input type='hidden' name='car_year[]' value='<?php echo $result[$k]["car_built"]; ?>' /><?php echo $result[$k]["car_name"]; ?> - <?php echo $result[$k]["car_built"]; ?> - <?php echo $result[$k]["charge"]; ?>	</td>
					<td><input type='hidden' name='car_totalday[]' value='<?php echo $result[$k]["days"]; ?>' /><input type='hidden' name='car_startdate[]' value='<?php echo $result[$k]["startdate"]; ?>' /><input type='hidden' name='car_enddate[]' value='<?php echo $result[$k]["enddate"]; ?>' /><?php echo $result[$k]["days"]; ?></td>
					<td><input type='hidden' name='car_totalnum[]' value='<?php echo $result[$k]["amount"]; ?>' /><?php echo $result[$k]["amount"]; ?></td>
					<td class="right"><input type='hidden' name='car_totalall[]' value='<?php echo $result[$k]["amount"]*$result[$k]["days"]*$result[$k]["charge"]; ?>' /><?php echo $result[$k]["amount"]*$result[$k]["days"]*$result[$k]["charge"]; ?></td>
					<td><span class='btnDeleteAction' onclick='deleteRow(<?php echo $i;?>)' ><img src='web/image/icon-delete.png' /></span></td>
				  </tr>
			...
			<tfoot>
				<tr  class="left">
                    ...
                    <th class="right"><strong id="subtotal"><?php echo $subtotal; ?></strong><input type="hidden" name="subtotalcar" id="subtotalcar" value="<?php echo $subtotal; ?>"/></th>
                </tr>
				<tr class="left">
                    <th colspan="3"><strong>Discount - rent for 3 days discount 5%</strong></th>
                    <th class="right"><strong id="disc1"><?php echo $discount1; ?></strong><input type="hidden" name="discount1" id="discount1"  value="<?php echo $discount1; ?>"/></th>
                </tr>
				<tr class="left">
                    <th colspan="3"><strong>Discount - rent 2 car or more discount 10%</strong></th>
                    <th class="right"><strong id="disc2"><?php echo $discount2; ?></strong><input type="hidden" name="discount2" id="discount2"  value="<?php echo $discount2; ?>"/></th>
                </tr>
				<tr class="left">
                    <th colspan="3"><strong>Discount - rent car built below 2010 discount 7%</strong></th>
                    <th class="right"><strong id="disc3"><?php echo $discount3; ?></strong><input type="hidden" name="discount3" id="discount3"  value="<?php echo $discount3; ?>"/></th>
                </tr>
                <tr  class="left">
                    <th colspan="3"><strong>Total</strong></th>
                    <th class="right"><strong id="total_all"><?php echo $total; ?></strong><input type="hidden" name="totalcar" id="totalcar"  value="<?php echo $total; ?>"/></th>
                </tr>
            </tfoot>
        </table>
